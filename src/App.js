  ...
  return (
    <div className="back">
      ...
      <div className="row row1 clear">
        ...
        {<Buttons value="%" class="mod" changeInput={changeInput} control={true} mod={true} />}
        {<Buttons value="Clear" class="clearElements" changeInput={changeInput} clear={true}/>}
      </div>
      <div className="row row2">
        ...
        {<Buttons value="/" class="divide" changeInput={changeInput} control={true} divide={true} />}
      </div>
      <div className="row row3">
        ...
        {<Buttons value="*" class="multi" changeInput={changeInput} control={true} multi={true} />}
      </div>
      <div className="row row4">
        ...
        {<Buttons value="-" class="minus" changeInput={changeInput} control={true} minus={true} />}
      </div>
